...
* List of Oneoff Tasks :typTask:catOneoff:PLATFORM:meta:
** PEND Organize Script repo :subGithub:
Organize ~scripts~ in ~/scipts~ and ~scripts~ in ~$PATH~
- [ ] Organize ~/scripts~
- [ ] Oragnize [[file:/home/whammou/notes/capture.org:NOTE:*Qtile scripts][qtile]] scripts
- [ ] Oragnize ~$PATH~
...
** DONE Create issue on nvim-orgmode (vim-regex) :subGithub:PACKAGES:subNvim:subOrgmode:
...
- *Reference:*  
** DONE Test HTTP Assets :subHTTP:subWebdav@subAsset:
DEADLINE: <2026-03-29 Sun> CLOSED: [2026-03-30 Mon 17:53]
:PROPERTIES:
:ID: dbbf26e3-dbee-4c71-bd0b-1fbb56d97b61
:END:
- *OBJECTIVE:*  Testing self-hosting assets site via =webdav=
#+begin_html html
<img src="https://media.whammou.dedyn.io/Journal/assets/balance-sheet.png" style="width:50%;"/>
#+end_html
