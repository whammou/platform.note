...
This is a write test on =wayland= with minimal load compare to =x11=
...
** TODO Uniform Latex Block on Github and in Orgmode :GITHUB:ORGMODE:mathrender:
DEADLINE: <2026-01-09 Fri>
...
*** Testing Math Syntax on Github
- *OBJECTIVE:* Testing the math rendering syntax on =Github=
  + This test looks fine on =nvim-orgmode=
  Here is a test: \( a \) $$a$$ \\
  This line contains inline math equation: $$x_2^3 + \int \frac{x_2^3}{x_3^1}\,dx$$
  This line paragraph contains math block
  #+BEGIN_SRC math
