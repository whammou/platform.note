...
#+FILETAGS: :topPlatform:typArchive:typTask:catOneoff:

* DONE Setting Gdrive scope :opDrive:subRclone:
...
* DONE Overhaul Note repo [100%] :subOrgmode:subGithub:
...
- *Goal(s):* modify and add README content
  - [ ] modify [[./README.org:topNote:repo-hierarchy][Hierarchy]]
...
* DONE Test quote block render :subOrgmode:subGithub:
