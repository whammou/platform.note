...
#+FILETAGS: :typDoc:catDraft:PLATFORM:
#+HTML:<details>

* Document Drafts :typDoc:catDraft:PLATFORM:meta:
#+HTML:</details>
...
#+END_QUOTE
** OUTL Orgmode github hacks :subOrgmode:subGithub:
:PROPERTIES:
...
** WAIT Github Actions :subGithub:GithubActions:
...
CLOSED: [2025-10-31 Fri 21:51] DEADLINE: <2025-10-31 Fri>
:PROPERTIES:
